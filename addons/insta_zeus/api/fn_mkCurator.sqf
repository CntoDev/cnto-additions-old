...
private _logic = (creategroup sideLogic) createUnit ["a3aa_insta_zeus_dumb_curator", [0,0,0], [], 0, "NONE"];
...
[_logic, {
     ...
     * - for a3aa_insta_zeus_curator itself, we don't care as it's re-assigned on

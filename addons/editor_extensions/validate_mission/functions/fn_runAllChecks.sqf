                ...
                "-------------------------" + endl;
{
    ...
    if (count _ents > 0) then {
        _ents = _ents apply {
                    "  - " + (_x call a3ee_validate_mission_fnc_getEntityInfo)
                };
    ...
    [
        "Overloaded units",
        a3ee_validate_mission_fnc_checkOverload
    ],
    [
        "Unique ACRE _ID_ radios",
        a3ee_validate_mission_fnc_checkAcreIds
    ],
    [
        "Playable unit ordering",
        a3ee_validate_mission_fnc_checkOrdering
    ]
];

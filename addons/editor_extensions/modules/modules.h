...
class a3aa_ee_briefing : a3aa_ee_shared_module_base {
    ...
    class Attributes {
        ...
        class admin_logistics {
            property = "a3aa_ee_briefing_logistics";
            control = "EditBig15";
        ...
        class command_signal {
            property = "a3aa_ee_briefing_command";
            control = "EditBig15";
...
class a3aa_ee_post_process : a3aa_ee_shared_module_base {
    ...
    class Attributes {
        ...
        class cc_enable {
            property = "a3aa_ee_post_process_cc";
            control = "Checkbox";
            displayName = "Enable";
            expression = "_this setVariable [""%s"",_value]";
            defaultValue = "false";
        ...
        class db_enable {
            property = "a3aa_ee_post_process_db";
            control = "Checkbox";
            displayName = "Enable";
            expression = "_this setVariable [""%s"",_value]";
            defaultValue = "false";
        ...
        class ca_enable {
            property = "a3aa_ee_post_process_ca";
            control = "Checkbox";
            displayName = "Enable";
            expression = "_this setVariable [""%s"",_value]";
            defaultValue = "false";
